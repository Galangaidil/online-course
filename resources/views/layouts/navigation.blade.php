                ...
                @guest
                    <div class="flex">
                        <div class="hidden space-x-3 sm:-my-px sm:ml-10 sm:flex">
                            <a href="{{ route('login') }}"
                                class="inline-flex items-center px-4 py-2 bg-white border border-transparent rounded-md font-medium text-xs text-blue-600 uppercase tracking-widest hover:bg-blue-100 active:bg-blue-200 focus:outline-none focus:border-blue-200 focus:ring ring-blue-200 disabled:opacity-25 transition ease-in-out duration-150">Log
                                in</a>
                            <a href="{{ route('register') }}"
                                class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-medium text-sm text-white capitalize tracking-normal hover:bg-blue-700 focus:outline-none focus:border-blue-600 focus:ring ring-blue-200 disabled:opacity-25 transition ease-in-out duration-150">Daftar
                                Gratis</a>
                        </div>
                    </div>
                @endguest
