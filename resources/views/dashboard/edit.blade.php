                        ...
                        <form action="{{ route('create') }}" method="post">
                            ...
                            <div class="mt-4">
                                ...
                                <textarea id="deskripsi" name="deskripsi"
                                    class="mt-1 resize-none w-full h-32 rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ $courses->deskripsi }}</textarea>
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <x-input id="thumbnail"
                                    ...
                                    type="file" name="thumbnail" :value="$courses->thumbnail" required />
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="flex">
                                    ...
                                    <x-input id="video" class="block mt-1 w-full rounded-l-none" type="text"
                                        name="video" :value="$courses->video" required />
                                </div>
                            </div>
